...
-- Weekly breakdown of mart_performance_cmg + mart_performance_month.
...
-- Updated 2026-06-16: uses sales_hoc_orders (mart_telesales_orders was removed).
...
LEFT JOIN mart_performance_cmg   p  ON p.month  = wm.owned_month AND p.dynamic_cmg = ws.dynamic_cmg
LEFT JOIN mart_performance_month pm ON pm.month = wm.owned_month;
